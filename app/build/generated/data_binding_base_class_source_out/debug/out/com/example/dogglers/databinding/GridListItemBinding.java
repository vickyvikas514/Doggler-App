...
public final class GridListItemBinding implements ViewBinding {
  ...
  private GridListItemBinding(@NonNull MaterialCardView rootView, @NonNull TextView age,
      @NonNull TextView hobbie, @NonNull ImageView itemImage, @NonNull TextView name) {
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.hobbie;
      TextView hobbie = ViewBindings.findChildViewById(rootView, id);
      if (hobbie == null) {
        break missingId;
      }
      ...
      return new GridListItemBinding((MaterialCardView) rootView, age, hobbie, itemImage, name);
    }
