...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
      val imageView:ImageView=view!!.findViewById(R.id.item_image)
        ...
        val textView1:TextView=view!!.findViewById(R.id.age)
        val textView2:TextView=view!!.findViewById(R.id.hobbie)
    ...
    override fun onBindViewHolder(holder: DogCardAdapter.DogCardViewHolder, position: Int) {
        ...
        holder.textView1.text=resources?.getString(R.string.dog_age,item.age)
        holder.textView2.text=resources?.getString(R.string.dog_hobbies,item.hobbies)
